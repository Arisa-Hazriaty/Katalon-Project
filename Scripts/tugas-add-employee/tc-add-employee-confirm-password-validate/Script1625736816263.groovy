...
WebUI.setEncryptedText(findTestObject('add-employee/txt-confirm-password'), 'iFGeFYmXIrVXw9FXIAOT/w==')
...
WebUI.verifyElementText(findTestObject('add-employee/alert-confirm-password'), 'Passwords do not match')
