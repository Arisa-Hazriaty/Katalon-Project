...
WebUI.verifyElementText(findTestObject('add-employee/alert-firstname-empty'), 'Required')

WebUI.verifyElementText(findTestObject('add-employee/alert-lastname-empty'), 'Required')
